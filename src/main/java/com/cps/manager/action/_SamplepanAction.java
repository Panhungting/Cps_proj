...
@Component("samplepanAction")
@ParentPackage("basePackage")
@Namespace("/")
@Action(className="samplepanAction",results={@Result(name="success", location="Samplepan.jsp")})
public class _SamplepanAction extends BaseAction{
