...
@Component("samplepanSqlAction")
@ParentPackage("basePackage")
@Namespace("/")
@Action(className="SamplepanSqlAction",results={@Result(name="success", location="SamplepanSqlTest.jsp")})
public class _SamplepanSqlAction_ extends BaseAction{
